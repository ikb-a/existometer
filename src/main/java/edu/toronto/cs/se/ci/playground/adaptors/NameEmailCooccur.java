...
public class NameEmailCooccur extends BasicAdaptor<Contact, Boolean, ContactTrust, List<String>, Boolean, Double> implements ContactValidate {

	public NameEmailCooccur() {
		super(Cooccur.class);
	}

	@Override
	public List<String> transformArgs(Contact args) {
		return ImmutableList.of(args.getName(), args.getEmail());
	}
